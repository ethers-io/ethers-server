...
var translateEthCalls = {
    ...
    eth_getTransactionByBlockHashAndIndex: 'eth_getTransaction',
    eth_getTransactionByBlockNumberAndIndex: 'eth_getTransaction',

    eth_getUncleByBlockHashAndIndex: 'eth_getUncle',
    eth_getUncleByBlockNumberAndIndex: 'eth_getUncle',

    eth_getBlockTransactionCountByHash: 'eth_getBlockTransationCount',
    eth_getBlockTransactionCountByNumber: 'eth_getBlockTransationCount',
...
function checkEthersCall(method, params) {
    return (ethersCalls[method] !== null);
}
